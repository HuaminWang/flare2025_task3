...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', type=str,default='/data/MultiOrganSeg/MR_data/npy')#required=True, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        self.parser.add_argument('--batchSize', type=int, default=1, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=300, help='scale images to this size')
        self.parser.add_argument('--fineSize', type=int, default=288, help='then crop to this size')
        ...
        self.parser.add_argument('--name', type=str, default='experiment_save', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--model', type=str, default='Organ_attention',help='chooses which model to use. Organ_attention')
        self.parser.add_argument('--which_direction', type=str, default='AtoB', help='AtoB or BtoA')
        self.parser.add_argument('--nThreads', default=1, type=int, help='# threads for loading data')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./Organ_attention_save', help='models are saved here')
        ...
        self.parser.add_argument('--write_folder', type=str, help='no dropout for the generator')
        self.parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        self.parser.add_argument('--data_aug', action='store_true', help='whether to use data augmentation')
        ...
        self.parser.add_argument('--pretrained_dir', type=str, default='./Organ_attention_save',
                                 help='path to the pretrained model')
        self.parser.add_argument('--target_domian', type=str, default='img_aug',
                                 help='path to the pretrained model')
