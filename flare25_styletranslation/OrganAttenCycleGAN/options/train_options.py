...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--Net', type=str, default='Split-Unet', help='Network_for_Seg: Unet|Split-Unet|DenseNet')
        self.parser.add_argument('--Organ_Attention_Type', type=str, default='concat', help='Attention type: concat|dot|add')
        self.parser.add_argument('--organ_num', type=int, default=14, help='# of organs')
        self.parser.add_argument('--partial_label', action='store_true', default=False, help='whether use partial labels to train the SegNet')
        self.parser.add_argument('--D_lr_mult', type=float, default=1.0, help='the mult of basic lr(the lr of Generator) for Discriminator')
        self.parser.add_argument('--N_disc', type=int, default=1, help='the interval of updating D')
        self.parser.add_argument('--gradient_clip', action='store_true', default=False, help='whether to clip the gradient of G in order to prevent gradient explosion')
        self.parser.add_argument('--max_norm', type=float, default=20.0, help='the max norm used in clip_grad_norm')
        self.parser.add_argument('--lambda_gp', type=float, default=5, help='the weight for gradient penalty loss')
        self.parser.add_argument('--only_resume_GDA', action='store_true', default=False, help='whether to only load the pretrained weights of G_A and D_A')
        self.parser.add_argument('--frozen_GDA', action='store_true', default=False, help='whether to froze the weights of G_A and D_A')
        self.isTrain = True
