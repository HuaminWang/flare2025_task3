...
class Organ_attention(BaseModel):
    ...
    def backward_G(self):
        ...
        att_map_fake_B=att_map_fake_B.view(att_map_fake_B.size(0), 1, 256, 256) #可以更灵活
        fake_B_local=fake_B_local.view(fake_B_local.size(0), 1, 256, 256)
    ...
    def get_current_visuals(self):
        ...
        pred_B=pred_B.view(pred_B.size(0), 1, 256, 256)
        pred_B=pred_B.data
