...
if __name__ == '__main__':
    ...
    # CoresetDataTrack_mr_dir= base_in_dir+'coreset_train_unlabeled_MRI_PET/MRI_unlabeled_100_random/'
    # ref_images = os.listdir(CoresetDataTrack_mr_dir)
    # # mada: +Delay +V +A Phase -pre _DWI T2WI
    # modas = ['amos','OutPhase', 'C+Delay', 'C-pre', 'C+V', 'C+A', 'InPhase', 'DWI', 'T2WI']
    # for moda in modas:
    #     for image in ref_images:
    #         if moda in image:
    #             out_npy_path = base_out_dir+'CoresetDataTrack/mri/train/'+moda
    #             if not os.path.exists(out_npy_path):
    #                 os.makedirs(out_npy_path)
    #             if len(os.listdir(out_npy_path)) < 80:
    #                 to_npy([image], CoresetDataTrack_mr_dir, out_npy_path, isMRI = True)
    #
    #
    # CoresetDataTrack_pet_dir=base_in_dir+'coreset_train_unlabeled_MRI_PET/PET_unlabeled_100_random/'
    # ref_images = os.listdir(CoresetDataTrack_pet_dir)
    # # mada:fdg, psma
    # modas = ['fdg','psma']
    # for moda in modas:
    #     for image in ref_images:
    #         if moda in image:
    #             out_npy_path = base_out_dir+'CoresetDataTrack/pet/train/'+moda
    #             if not os.path.exists(out_npy_path):
    #                 os.makedirs(out_npy_path)
    #             if len(os.listdir(out_npy_path)) < 80:
    #                 to_npy([image], CoresetDataTrack_pet_dir, out_npy_path, isMRI = True)
    #
    ...
    # # /home/data3/whm/dataset/flare25/FLARE-MedFM/npy_slice/temp/
    # ct_lab_4organ_path_50 = base_out_dir+'temp/train_CT_gt_label/labelsTr/' # pet lab attention 4 organs
    # ct_4labels = os.listdir(ct_lab_4organ_path_50)
    # # to_npy(ct_4labels, ct_lab_4organ_path_50, base_out_dir+'CoresetDataTrack/pet/train/lab',isimage = False, isCT = True)
    # to_npy(ct_4labels, ct_lab_4organ_path_50, '/home/data3/whm/dataset/flare25/FLARE-MedFM/npy_slice/AllDataTrack/pet/train/lab',isimage = False, isCT = True)


    # ct_img_path_50 = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task012_flare/CT/images'
    # ct_lab_path_50 = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task012_flare/CT/labels'
    # mr_img_path_110 = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task012_flare/PublicValidation/imagesVal'
    # mr_plab_path_110 = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task012_flare/PublicValidation/labelsVal'
    #
    # train_nn = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task012_flare/imagesTr'
    #
    # ct_mr = '/data2/jianghao/nnUNetFrame/brain_lesion/data/result-flare/flare_1/fake_B'
    #
    # ref_dir = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task12_flare/LLD-MMRI-3984'
    ...
    #     for image in ref_images:
    #         if moda in image:
    #             out_npy_path = '/data2/jianghao/nnUNetFrame/brain_lesion/data/flare/train/'+moda
    #             if not os.path.exists(out_npy_path):
    #                 os.makedirs(out_npy_path)
    #             if len(os.listdir(out_npy_path)) < 80:
    #                 to_npy([image],ref_dir, out_npy_path, isMRI = True)
    ...
    # mr_images = os.listdir(mr_img_path_110)
    # mr_labels = os.listdir(mr_plab_path_110)
    # ct_images = os.listdir(ct_img_path_50)

    # path_ = '/data2/jianghao/challenge/MMIS/data_3d/task2/4'
    # save_path = '/data2/jianghao/nnunet_v2/DATASET/nnUNet_raw/Dataset023_copyp/labelsTs'
    # all_imagesss = os.listdir(path_)
    # all_images = [item for item in all_imagesss if '0000' in item]
    # creat_empty_label(all_images,path_,save_path)
    # convert_label(all_images,path_,path_)

    # norm(all_images, path_, path_, isMRI=True )
    # # path_ = '/data2/jianghao/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task015_brainlesion_c2/imagesTr'
    # # for prefix in ['OutPhase', 'C+Delay', 'C-pre', 'C+V', 'C+A', 'InPhase', 'DWI', 'T2WI']:
    # # prefix = 'T2WI_'
    # rename_files_in_directory(save_path, old_rep='_0000.nii', new_rep='.nii', to_0000 = False, to_0001=None)

    # # to_npy(ref_images, ref_dir, '/data2/jianghao/nnUNetFrame/brain_lesion/data/flare/tempo',isimage = True, isMRI = True)

    # to_npy(mr_labels, mr_plab_path_110, '/data2/jianghao/nnUNetFrame/brain_lesion/data/flare/train/lab_aug',isimage = False, isMRI = True)
    # to_npy(ct_images, ct_img_path_50, '/data2/jianghao/nnUNetFrame/brain_lesion/data/flare/train/img',isimage = True, isCT = True)